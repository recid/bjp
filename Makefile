# This Makefile is for the bjp extension to perl.
#
...
#     NAME => q[bjp]
#     PL_FILES => {  }
#     PREREQ_PM => { YAML=>q[0], Dancer2=>q[0.152], Test::More=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/bjp.pm]
#     clean => { FILES=>q[bjp-*] }
...
TO_INST_PM = lib/bjp.pm

PM_TO_BLIB = lib/bjp.pm \
	blib/lib/bjp.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: bjp' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dancer2: '\''0.152'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "bjp",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dancer2" : "0.152",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dancer2::" VERSION="0.152" />' >> $(DISTNAME).ppd
